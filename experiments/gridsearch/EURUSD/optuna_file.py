...
def main():
    ...
    parser.add_argument("--bin", required=True, help="Path to C++ binary, e.g. ./gridsearch_eurusd_test")
    ...
    # Search spaces
    parser.add_argument("--lags_min", type=int, default=30)
    parser.add_argument("--lags_max", type=int, default=150)
    parser.add_argument("--lags_step", type=int, default=15)

    parser.add_argument("--window_min", type=int, default=40)
    parser.add_argument("--window_max", type=int, default=600)
    parser.add_argument("--window_step", type=int, default=30)
